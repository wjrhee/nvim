...
-- Take line below and append to currently line with space. Keep cursor same spot
vim.keymap.set("n", "J", "mzJ`z")

-- Keep cursor in same spot when moving up and down
...
-- Copies buffer to clipboard
vim.keymap.set({"n", "v"}, "<leader>y", [["+y]])
vim.keymap.set("n", "<leader>Y", [["+Y]])

vim.keymap.set({"n", "v"}, "<leader>d", [["_d]])

-- Saving after multi-cursor edit
